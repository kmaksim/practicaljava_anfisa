...
@WebServlet(urlPatterns = { "/quote1" }, initParams = { @WebInitParam(name = "symbol", value = "AAPL") })
public class QuoteGeneratorPostMethod extends HttpServlet {
  private static final long serialVersionUID = 1L;

  /**
   * @see HttpServlet#HttpServlet()
   */
  public QuoteGeneratorPostMethod() {
    super();
  }
  ...
  protected void doGet(HttpServletRequest request, HttpServletResponse response)
    ...
    out.println(" <form action=http://localhost:8080/unit14_anfisa2/quote1 method=Post>");
