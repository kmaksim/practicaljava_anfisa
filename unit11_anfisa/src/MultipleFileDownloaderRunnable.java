...
public class MultipleFileDownloaderRunnable {
  ...
  public static void main(String[] args) {
    ...
    ArrayList<FileDownloader2> tasks = new ArrayList();
    
    for (String filename : filesToDownload) {
      tasks.add(new FileDownloader2(filename));
    }
    
    for (FileDownloader2 task : tasks  ) {
