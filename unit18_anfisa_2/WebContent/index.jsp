<%@ page import="com.practicaljava.lesson34.StockService.*"%>
...
<body>
	...
	<%
		out.println("<h3> The following Stocks were already added with uptodate data from YAHOO:<br>"  
	+ com.practicaljava.lesson34.StockService.getPredefinedStockNames() + " </h3>");
	%>

	<form id="get-stock" action="javascript:alert('submit')">
		<input id="get-stock-symbol" type="text" /> <input class="button"
		...
		<fieldset>
			<ol>
				...
				<li><label for="add-stock-price">Price</label> <input
					id="add-stock-price" name="price" type="text" /></li>
	...
	<script>
		...
		$("#get-stock").submit(
				function() {
					$.getJSON('/unit18_anfisa_2/restfulstocks/stock/'
							+ $("#get-stock-symbol").val(), function(data) {
		...
		$("#add-stock").submit(
				function() {
					...
					$.ajax({
						type : "POST",
						url : '/unit18_anfisa_2/restfulstocks/stock',
