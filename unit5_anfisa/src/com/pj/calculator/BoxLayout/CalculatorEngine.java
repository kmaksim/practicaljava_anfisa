package com.pj.calculator.BoxLayout;
 ...
 public void actionPerformed(ActionEvent e){
   ...
   switch (clickedButtonLabel) {
   	   case "=":
   		   ...
   		   System.out.println("savedOperator>" +savedOperator + "<");
   		   if (!savedOperator.equals("=")) {
			   ...
			   System.out.println("parent.getDisplayOperatorValue>" +parent.getDisplayOperatorValue() + "<");
			   if (!numbersLCDValue.isEmpty() && !num1.isEmpty() 
