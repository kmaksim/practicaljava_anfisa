...
public class CalculatorEngine implements ActionListener {
 ...
 private String performCalculation(String num1, String num2,String operator) {
	 ...
	 try {
		return (engine.eval(num1 + operator + num2).toString());
 ...
 public void actionPerformed(ActionEvent e){
   ...
   switch (clickedButtonLabel) {
   	   case "=":
   		...
   		Calculator.log.info("savedOperator>" +savedOperator + "<");
   		   if (!savedOperator.equals("=")) {
			   ...
			   Calculator.log.info("parent.getDisplayOperatorValue>" +parent.getOperatorLCDValue() + "<");
			   if (!numbersLCDValue.isEmpty() && !num1.isEmpty() 
					   && !savedOperator.equals(clickedButtonLabel)
					   && !(parent.getOperatorLCDValue().length()>0)) {
	   ...
	   case "*": case "/": case "-": case "+":
		    ...
		    */
		   parent.setOperatorLCDValue(clickedButtonLabel);
